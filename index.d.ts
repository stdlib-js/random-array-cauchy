...
/**
* Interface for generating pseudorandom numbers drawn from a Cauchy distribution with pre-specified parameter values.
*/
...
/**
* Interface for generating pseudorandom numbers drawn from a Cauchy distribution without pre-specified parameter values.
*/
interface TernaryFunction extends PRNG {
	...
	* @returns output array
	*/
	( len: number, x0: number, gamma: number, options?: Options ): RandomArray;
	...
	* @returns output array
	*/
	assign( x0: number, gamma: number, out: RandomArray ): RandomArray;
}
...
interface Random extends PRNG {
	...
	* // returns <Float64Array>
	*/
	factory( x0: number, gamma: number, options?: FactoryOptions ): UnaryFunction;
